  ...
  return (
    ...
    <div className="thriftr-container">
      ...
      <section className="hero-section">
        <h1>Find Clothes<br />You Want.</h1>
      ...
      <section className="how-it-works">
        <div className="content-wrapper">
          ...
          <p className="description">
            With our shop you swipe right if you like the item. And swipe left if you don't. 
            Careful though, because once you swipe left you'll never see it again!
          </p>
          ...
          <div className="info-grid">
            <div className="info-box">
              ...
              <ul>
                ...
                <li>You can receive feedback if the item you want goes with anything you have on our closet page</li>
              </ul>
            </div>
      ...
      <footer className="footer">
        ...
        <div className="footer-links">
          <a href="#signup">Sign up</a> | <a href="#contact">Contact</a> | <a href="#about">About</a>
        </div>
      </footer>
    </div>
          {authOpen && (
